...
write.csv(pred.train, file='results/trainPredictionMultivariateLinearRegressionNodes.csv', quote=FALSE, row.names=TRUE) #CHANGE7
save(pred.train, file = 'results/trainPredictionMultivariateLinearRegressionNodes.RData') #CHANGE7
write.csv(pred.test, file='results/testPredictionMultivariateLinearRegressionNodes.csv', quote=FALSE, row.names=TRUE) #CHANGE8
save(pred.test, file = 'results/testPredictionMultivariateLinearRegressionNodes.RData') #CHANGE8
write.csv(error, file='results/errorsMultivariateLinearRegressionNodes.csv', quote=FALSE, row.names=TRUE) #CHANGE9
save(error, file = 'results/errorsMultivariateLinearRegressionNodes.RData') #CHANGE9
